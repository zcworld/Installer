...
deb http://192.168.137.239/ubuntu trusty main restricted universe multiverse
deb http://192.168.137.239/ubuntu trusty-security main restricted universe multiverse
deb http://192.168.137.239/ubuntu trusty-updates main restricted universe multiverse
...
mv -f /etc/zpanel/panel/modules/apache_admin/hooks/OnDaemonRun.hook.php_u14 /etc/zpanel/panel/modules/apache_admin/hooks/OnDaemonRun.hook.php
